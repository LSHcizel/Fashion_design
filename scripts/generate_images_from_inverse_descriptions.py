...
def main() -> None:
    ...
    if use_chapter:
        ...
        logger.info("模式：chapter | 目录=%s", chapter_dir.relative_to(REPO_ROOT))
    else:
        ...
        logger.info("模式：inverse | 目录=%s", inverse_dir.relative_to(REPO_ROOT))
    ...
    logger.info(
        ...
        skipped,
        failed,
        failures_path.relative_to(REPO_ROOT),
    )
